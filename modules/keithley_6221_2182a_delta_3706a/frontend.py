...
class Keithley6221Delta3706AFrontend(QWidget):
    ...
    def _build_settings(
        ...
        self.resource_3706a = self._resource_combo()
        ...
        communication_layout.addWidget(
            QLabel("Keithley 3706A VISA resource"),
            1,
            0,
        )
        communication_layout.addWidget(
        ...
        self.switcher_note = QLabel(
            "3706A state has not been checked yet."
        )
    ...
    def dump(self) -> dict[str, Any]:
        ...
        return {
            ...
            "resource_3706a": (
                self.resource_3706a.currentText().strip()
            ),
    ...
    def show_status(
        ...
        if switcher:
            ...
            self.switcher_note.setText(
                (
                    "3706A available: CH1-CH4 may be used."
                    if self._switcher_available
                    else (
                        "3706A unavailable: only CH1 will be "
